...
export function PortalNav({ activeHref, participantRole, previewQuery = "" }: { activeHref: string; participantRole?: ParticipantRole; previewQuery?: string }) {
  const roleNav = participantRole === "sponsor"
    ...
    : participantRole === "vendor"
      ? [portalNav[0], { href: "/portal/application", label: "Application" }, { href: "/portal/payment", label: "Payment" }, { href: "/portal/brand-profile", label: "Brand profile" }, { href: "/portal/handbook", label: "Handbook" }, ...portalNav.slice(1)]
      : portalNav;
